...
<StepCard title="Define Units (Inventory)" description="Create rooms, villas, cabins, and link calendars with effective dates.">
  - **Open**: `/inventory`  
  - **Basics**: Name, Unit #, Type, Description. Note that the combination of Name and Unit # creates a unique ID for the Unit. 
...
<StepCard title="Test Reservations" description="Simulate availability and confirm bookings that persist to the database.">
  - **Open**: `/test`  
  - **Select Unit**  
