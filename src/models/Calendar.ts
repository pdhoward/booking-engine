...
export type CalendarDoc = InferSchemaType<typeof calendarSchema>;

const CalendarModel: Model<CalendarDoc> =
  (mongoose.models.Calendar as Model<CalendarDoc>) ||
  mongoose.model<CalendarDoc>("Calendar", calendarSchema);
